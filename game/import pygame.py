...
class player:
    ...
    def __init__(self):
        ...
        self.body = pygame.transform.scale(pygame.image.load('sprite-0002.png'),(self.body_width,self.body_height))
        self.velocity = 1
        self.velocitx = 0
    ...
    def move(self):
        ...
        if self.keyboard['u'] == 1:
            if self.jump==self.jump_limiter:
                self.acceleration = -1
                if self.velocity < 25 and self.velocity > -25:
...
def map_printer():
    ...
    file = r'D:\Dev\Python\game\maap.txt'
    ...
    pic1 = pygame.image.load('sprite-0001.png')
    pic2 = pygame.image.load('sprite-0001.png')
